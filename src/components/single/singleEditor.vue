<template>
  ...
  const props = defineProps({
    ...
    plugins: {
      type: [String, Array],
      default:"image link codesample  emoticons lists fullscreen preview",
    },
    knwlgId: {
      type: String,
    },
    toolbar: {
      ...
      default: "blocks | bold |lists|blockquote | align numlist bullist | link  | removeformat  |emoticons | codesample|islideImage|islideHide|fullscreen|preview",
    },
    readonly: {
      type: Boolean,
      default: false,
